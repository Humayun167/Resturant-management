...
struct node* createadmin(struct node *head,int data, char foodname[25], float price)
{
    ...
    newnode->price = price;
    newnode-> quantity = 0;
    strcpy(newnode->food_name,foodname);
    newnode->next = NULL;
    newnode->prev = NULL;
...
struct node* createcustomer(struct node *head,int data,int quantity)
{
    ...
    if(flag==1)
    {
        ...
        strcpy(newnode->food_name,temp1->food_name);
        newnode->next = NULL;
        newnode->prev = NULL;
...
void displayList(struct node *head)
{
    ...
    else
    {
        ...
        {
            if(temp1->quantity==0)
                printf("\t\t\t\t\t\t\t%d\t%s\t%0.2f\n",temp1->data,temp1->food_name,temp1->price);
            else
            {
                printf("\t\t\t\t\t\t\t%d\t%s\t%d\t%0.2f\n",temp1->data,temp1->food_name,temp1->quantity,temp1->price);
            }
